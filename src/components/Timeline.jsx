...
const Timeline = () => {
  ...
  const trackPath = `M50,30 L150,80 Q200,120 250,150 Q300,200 200,250 Q150,300 150,350 Q200,400 250,450 Q300,500 350,500 Q400,550 250,600`;
  ...
  return (
    <section id="timeline" className="relative p-4 md:p-6">
      <video
        autoPlay
        loop
        muted
        ...
        <svg viewBox="0 0 450 700" className="w-full h-auto">
          ...
          {timelineEvents.map((event) => (
            <g key={event.id} transform={`translate(${event.x},${event.y})`}>
              ...
              <foreignObject x="-40" y="15" width="100" height="100">
                <motion.div
                  className="bg-black/90 p-1 md:p-2 rounded-lg border border-primary text-white text-[8px] md:text-[10px] text-center"
