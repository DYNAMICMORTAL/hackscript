...
const ScrollSpeedIndicator = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const currentSpeed = Math.min(Math.round((scrollDiff / timeDiff) * 1000), 200);
    ...
    return (
        <div className="fixed right-4 bottom-4 bg-black p-4 rounded-lg border-2 border-red-500 shadow-xl z-[9999] pointer-events-none">
